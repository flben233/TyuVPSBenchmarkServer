...
func AddReport(rawHTML string) (string, error) {
	...
	report := &model.BenchmarkResult{
		...
		SpdTest:   model.JSONField[[]model.SpeedtestResults]{Data: &parsedResult.SpdTest},
		ECS:       model.JSONField[model.ECSResult]{Data: &parsedResult.ECS},
		Media:     model.JSONField[model.MediaResults]{Data: &parsedResult.Media},
		BestTrace: model.JSONField[[]model.BestTraceResult]{Data: &parsedResult.BestTrace},
		Itdog:     model.JSONField[model.ItdogResult]{Data: &parsedResult.Itdog},
		Disk:      model.JSONField[model.TyuDiskResult]{Data: &parsedResult.Disk},
		IPQuality: model.JSONField[model.IPQualityResult]{Data: &parsedResult.IPQuality},
